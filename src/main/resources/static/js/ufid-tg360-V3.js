...
ufidMod.calltgMid = function(url){
    $.ajax({
       type: 'GET',
       url: url,
       dataType:"json",
...
ufidMod.tgUfidCall = function(redirectUrl) {
    ...
    if (ufidMod.isEmpty(_tg_mid)) {  // _tg_mid 가 널일 경우.
        ...
        // t_mid생성 위해 tgm REST_API 호출
        ufidMod.calltgMid(ufidMod.uf_tgm_req_url);
        // ufidMod.ajaxCall(ufidMod.uf_tgm_req_url, function (xhr) {
        //     var res = null;
        //     try {
        ...
        //     }
        //
        //     console.log("ufidMod.uf_tgm_req_url responseText: "+xhr.responseText);
        //
        //     if (res && res.status) {
        //         console.log("--------------------");
